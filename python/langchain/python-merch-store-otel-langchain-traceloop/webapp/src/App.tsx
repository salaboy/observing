  ...
  const retroChrome = (
    <>
      ...
      <div style={{
        ...
        <a href="https://github.com/salaboy/observing-ai/tree/main/python/langchain/python-merch-store-otel-langchain-traceloop">Python Merch Store (OTel Langchain Traceloop)</a>
